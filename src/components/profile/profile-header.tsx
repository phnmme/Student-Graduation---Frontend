...
export function ProfileHeader({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-iptm-navy p-6 pb-24 md:pb-6">
      ...
      <div className="relative flex flex-col items-center gap-5 md:flex-row md:items-center">
        ...
        {!isEdit && (
          <button
            type="button"
            onClick={onEditClick}
            className="absolute bottom-4 right-4 cursor-pointer inline-flex items-center gap-2 rounded-lg bg-iptm-gold px-4 py-2 text-sm font-medium text-bluez-tone-5 transition hover:bg-iptm-gold/90 md:static"
          >
